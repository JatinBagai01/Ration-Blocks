...
<head>
<meta charset="utf-8">
<title>Saratov - Kindergarten HTML Template | Teachers</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <!--Teachers Section-->
    <section class="teachers-section teacher-page">
    	<div class="auto-container">
        	<div class="row clasic-block">
            	...
            	<div class="teacher-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<img src="images\resource\teacher-4.jpg" alt="">
                        </div>
            	...
            	<div class="teacher-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<img src="images\resource\teacher-5.jpg" alt="">
                        </div>
                        <h3>Kristen Stewart</h3>
                        <div class="designation">Maths Teacher</div>
                        <div class="text">The ship set ground on the shore of this uncharted a desert isle with that this group would s form a family.</div>
                        <ul class="social-links-one">
                        	<li><a href="#"><span class="fa fa-facebook-square"></span></a></li>
                            <li><a href="#"><span class="fa fa-twitter-square"></span></a></li>
            	...
            	<div class="teacher-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<img src="images\resource\teacher-6.jpg" alt="">
                        </div>
                        <h3>Ben Anderson</h3>
                        <div class="designation">Games Teacher</div>
                        <div class="text">The ship set ground on the shore of this uncharted a desert isle with that this group would s form a family.</div>
                        <ul class="social-links-one">
                        	<li><a href="#"><span class="fa fa-facebook-square"></span></a></li>
                            <li><a href="#"><span class="fa fa-twitter-square"></span></a></li>
